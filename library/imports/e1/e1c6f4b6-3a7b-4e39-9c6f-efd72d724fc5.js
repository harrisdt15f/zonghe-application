"use strict";
cc._RF.push(module, 'e1c6fS2OntOOZxv79ctck/F', 'PayRecordPanel');
// Script/Hall/shop/PayRecordPanel.ts
...
var PayRecordPanel = /** @class */ (function (_super) {
    __extends(PayRecordPanel, _super);
    function PayRecordPanel() {
    ...
    PayRecordPanel.prototype.onLoad = function () {
        ...
        if (this.typeList) {
            ...
            this._typeMenu.menuData = Language_1.G_Language.get("payStateList");
            var _length = Language_1.G_Language.get("payStateList").length;
            if (_length >= 8) {
    ...
    PayRecordPanel.prototype.onEnable = function () {
        this.mainObj.active = true;
        this.detailObj.active = false;
        PayControl_1.G_PayControl.requesPayRecord(function (ret) {
            this.showInfo();
        }.bind(this));
    };
    PayRecordPanel.prototype.onChaXun = function () {
        ...
        //var selectedText = this._typeMenu.selectResult.text;
        this.curList = PayControl_1.G_PayControl.getPayConfig().getPayRecordListInfo(typeId, this.curBeginTimeDate, this.curEndTimeDate);
        this.list.numItems = this.curList.length;
    };
    PayRecordPanel.prototype.showInfo = function () {
        this.getTimeDate();
        this.onChaXun();
    };
    PayRecordPanel.prototype.onToggleClick = function (event) {
        //console.log("event.name:",event.target._localZOrder)
        this.dateType = event.target._localZOrder; //1.全部 2.昨日 3.今日 4.上周 5.上月
        this.getTimeDate();
    };
    PayRecordPanel.prototype.getTimeDate = function () {
        Utils_1.G_Utils.getTimeDate(this.dateType, function (begin, end) {
            this.curBeginTimeDate = begin;
            this.curEndTimeDate = end;
        }.bind(this));
    };
    PayRecordPanel.prototype.onListRender = function (item, idx) {
        ...
        if (this.curList.length > idx) {
            ...
            if (cur.recharge_status == 0) //未支付
             {
                _str = Language_1.G_Language.get("payStateList")[1];
            }
            else if (cur.recharge_status == 1 && cur.status == 0) //已支付/审核中
             {
                _str = Language_1.G_Language.get("payStateList")[2];
            }
            else if (cur.recharge_status == 1 && cur.status == 1) //充值成功
             {
                _str = Language_1.G_Language.get("payStateList")[3];
            }
    ...
    PayRecordPanel.prototype.onRequestData = function (item, idx) {
    ...
    PayRecordPanel.prototype.onDetailClick = function (event) {
    ...
    PayRecordPanel.prototype.onDetailClose = function () {
        this.mainObj.active = true;
        this.detailObj.active = false;
    };
    __decorate([
        property(List_1.default)
    ], PayRecordPanel.prototype, "list", void 0);
    __decorate([
        property(cc.Node)
    ], PayRecordPanel.prototype, "typeList", void 0);
    __decorate([
        property(cc.Node)
    ], PayRecordPanel.prototype, "stateList", void 0);
    __decorate([
        property(cc.Node)
    ], PayRecordPanel.prototype, "btnChaXun", void 0);
    __decorate([
        property(cc.Node)
    ], PayRecordPanel.prototype, "mainObj", void 0);
    __decorate([
        property(cc.Node)
    ], PayRecordPanel.prototype, "detailObj", void 0);
    __decorate([
        property(cc.Label)
    ], PayRecordPanel.prototype, "detail_MoneyText", void 0);
    __decorate([
        property(cc.Label)
    ], PayRecordPanel.prototype, "detail_StateText", void 0);
    __decorate([
        property(cc.Label)
    ], PayRecordPanel.prototype, "detail_OrderText", void 0);
    __decorate([
        property(cc.Label)
    ], PayRecordPanel.prototype, "detail_TimeText", void 0);
    __decorate([
        property(cc.Label)
    ], PayRecordPanel.prototype, "detail_TypeText", void 0);
    __decorate([
        property(cc.Label)
    ], PayRecordPanel.prototype, "detail_DescText", void 0);
    PayRecordPanel = __decorate([
        ccclass
    ], PayRecordPanel);
    return PayRecordPanel;
}(cc.Component));
exports.default = PayRecordPanel;
