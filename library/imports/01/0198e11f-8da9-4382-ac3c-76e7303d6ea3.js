"use strict";
cc._RF.push(module, '0198eEfjalDgqw8ducwPW6j', 'recoverPanel');
// Script/Hall/Login/recoverPanel.ts
...
var recoverPanel = /** @class */ (function (_super) {
    __extends(recoverPanel, _super);
    ...
    recoverPanel.prototype.onLoad = function () {
    ...
    recoverPanel.prototype.start = function () {
    };
    recoverPanel.prototype.update = function (dt) {
        if (this.cd_time > 0) {
            this.cd_time -= dt;
            this.onCheckVerificationState();
        }
    };
    recoverPanel.prototype.onEnable = function () {
        var name = UserControl_1.G_UserControl.getUser().userMobile;
        if (name)
            this.phoneNumInfo = name;
        this.onCheckVerificationState();
    };
    recoverPanel.prototype.onCheckVerificationState = function () {
        if (this.cd_time > 0) {
    ...
    recoverPanel.prototype.onVerificationClick = function () {
    ...
    recoverPanel.prototype.onLanding = function () {
    ...
    Object.defineProperty(recoverPanel.prototype, "phoneNumInfo", {
        get: function () {
    ...
    Object.defineProperty(recoverPanel.prototype, "passwordInfo", {
        get: function () {
    ...
    Object.defineProperty(recoverPanel.prototype, "passwordAgainInfo", {
        get: function () {
    ...
    Object.defineProperty(recoverPanel.prototype, "verificationInfo", {
        get: function () {
    ...
    __decorate([
        property(cc.Node)
    ], recoverPanel.prototype, "phoneNumEditbox", void 0);
    __decorate([
        property(cc.Node)
    ], recoverPanel.prototype, "passwordEditbox", void 0);
    __decorate([
        property(cc.Node)
    ], recoverPanel.prototype, "passwordAgainbox", void 0);
    __decorate([
        property(cc.Node)
    ], recoverPanel.prototype, "verificationBox", void 0);
    __decorate([
        property(cc.Node)
    ], recoverPanel.prototype, "verBtnLanding", void 0);
    __decorate([
        property(cc.Label)
    ], recoverPanel.prototype, "cdTimeLabel", void 0);
    __decorate([
        property(cc.Node)
    ], recoverPanel.prototype, "btnLanding", void 0);
    recoverPanel = __decorate([
        ccclass
    ], recoverPanel);
    return recoverPanel;
}(cc.Component));
exports.default = recoverPanel;
