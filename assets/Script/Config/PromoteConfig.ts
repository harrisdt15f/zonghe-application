...
export  class PromoteConfig {
   ...
   // --------------------------- 推广收益  下属层级下拉列表 对应配置  ------------------------------- 
    ...
    private underLabelNameList = [];   
    /**
     * 
     * @param index  小于0 传list, 大于 0 传指定 item
     */
    public getCurUnderLabelStr(index) 
    {       
        if(this.underLabelNameList.length <= 0)
        {
            for(let i =0; i < 4;i++)
            {   
                let con = this.underLabelConfig[i]
                let str = G_Language.get(con.name);
                console.log("str   ",str);
     ...
     * @param endTime  结束时间
     */
    public getProRewardListInfo(_type,beginTime,endTime){
     
        //假数据
        if(this.ProRewardList.length <= 0)
        {          
            let a = {"id":34323,"level":1,"score":-3434,"reward":55,"created_at":"2020-03-04 19:44:52",}
            let b = {"id":543,"level":2,"score":234.54,"reward":0,"created_at":"2020-03-05 08:08:26",}
            let c = {"id":323,"level":1,"score":-6556.322,"reward":122.343,"created_at":"2020-02-15 11:59:35",}
            let d = {"id":353,"level":1,"score":4232,"reward":0,"created_at":"2020-03-04 22:41:26",}
            let e = {"id":2343,"level":2,"score":-1111.343,"reward":665.2321,"created_at":"2020-02-28 19:21:21",}
            let f = {"id":765,"level":1,"score":4545,"reward":0,"created_at":"2020-02-02 19:33:00",}
            let g = {"id":11,"level":1,"score":433,"reward":0,"created_at":"2020-02-02 19:33:00",}
            let h = {"id":22,"level":1,"score":234,"reward":0,"created_at":"2020-02-22 11:23:00",}
            let j = {"id":54,"level":2,"score":-133,"reward":4,"created_at":"2020-02-09 21:11:00",}
            let k = {"id":34,"level":3,"score":-10000,"reward":200,"created_at":"2020-03-02 18:34:00",}
        ...
        let list = [];
        this.ProRewardList.forEach(item=>{
    ...
    private WashRewardList = []
    /**
     * 洗码收益数据list
     * @param beginTime 开始时间
     * @param endTime  结束时间
     */
    public getWashRewardListInfo(beginTime,endTime){
        //假数据
        if(this.WashRewardList.length <= 0)
        {          
            let a = {"name":"AA平台","bet":2322.2,"pro":0.05,"money":25,"created_at":"2020-03-05 08:08:26",}
            let b =  {"name":"BB平台","bet":222.455,"pro":0.05,"money":55,"created_at":"2020-03-04 22:41:26",}
            let c =  {"name":"CC平台","bet":5422.3,"pro":0.05,"money":15,"created_at":"2020-02-02 19:33:00",}
            let d =  {"name":"DD平台","bet":236542.1,"pro":0.05,"money":456,"created_at":"2020-03-05 14:44:52",}
            let e =  {"name":"AA平台","bet":5322.244,"pro":0.05,"money":25,"created_at":"2020-02-15 11:59:35",}
            let f =  {"name":"AC平台","bet":232565.0,"pro":0.05,"money":33,"created_at":"2020-02-02 19:33:02",}
            let g =  {"name":"BD平台","bet":6666,"pro":0.05,"money":88,"created_at":"2020-03-04 19:44:52",}
            let h =  {"name":"FF平台","bet":0,"pro":0.05,"money":0,"created_at":"2020-03-01 16:04:12",}
            let j =  {"name":"TT平台","bet":5433,"pro":0.05,"money":45,"created_at":"2020-02-09 21:11:00",}
            let k =  {"name":"TS平台","bet":1233,"pro":0.05,"money":15,"created_at":"2020-03-02 18:34:00",}
        ...
        // console.log("endTime     ",endTime);
        let list = [];
        this.WashRewardList.forEach(item=>{
            let curTime = Date.parse(item.created_at)
            if(curTime >= beginTime && curTime <= endTime)
            {
                list.push(item);
